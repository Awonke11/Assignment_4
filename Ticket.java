...
public class Ticket {
    ...
    /**
     * Given the current time, determine this ticket's age i.e. subtract issue time
     * from current time.
     */
    ...
    /**
     * Obtain a String representation of this Ticket in the form
     * 'Ticket[id="dddddddd", time="hh:mm:ss", <valid/void>]'.
     */
